    ...
    <div className="">
      ...
      >
        <div data-aos="fade-up" className="">
          <div className="text-center mt-60 font-bold text-[80px] max-[1030px]:text-[60px] max-[790px]:text-[40px]   max-[500px]:text-[30px] max-[1030px]:leading-[60px] max-[600px]:leading-[50px] max-[500px]:leading-[30px] leading-[90px]">
