  ...
  return (
    <div className="">
      <div data-aos="fade-up" className="">
        <div className="text-center mt-20 font-bold text-[100px] leading-[100px]">
          English lessons <br /> free and premium
        </div>
        <div className="text-center text-[32px] mt-5 bg-gradient-to-r from-[#3c7093]  to-[#fb1d35] bg-clip-text text-transparent">
      ...
      <div className="flex gap-5 my-20 place-content-center">
        <Link
          data-aos="fade-right"
          href="https://lesson-english2-omega.vercel.app/"
          target="_blank"
      ...
      >
        <Image src={logo} alt="Logo" width={1200} height={1200} />
      </div>
    </div>
  );
}
