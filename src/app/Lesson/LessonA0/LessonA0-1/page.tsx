...
import { rusEngText1 } from "./RusEngText1.js";
export default function Home() {
  ...
  return (
    <div className=" ">
      <div className="flex justify-end  max-[850px]:justify-start   w-[900px] ms-10 mt-5 me-10">
        <Link
      ...
      <div className="flex gap-8 items-center max-[1350px]:text-[20px] max-[850px]:items-start max-[850px]:text-[18px] max-[850px]:flex-col border-b-2 border-white pb-10 mt-10 ms-10  max-[850px]:w-[700px] w-[900px]">
