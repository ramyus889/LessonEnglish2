  ...
  return (
    <div className="">
      <div className="inline-block">
        <div className="flex justify-between max-[930px]:justify-center max-[900px]:justify-start max-[640px]:w-[160px] max-[500px]:ms-5  max-[640px]:flex-col max-[930px]:gap-5  w-[900px] ms-10 mt-20 me-10">
          <Link
